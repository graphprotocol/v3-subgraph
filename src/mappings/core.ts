...
class PoolData {
  constructor(timestamp: i32, pool: Pool) {
  ...
  set volumeUSD(vol: BigDecimal) {
    assert(false, "not implemented")
  }

  set volumeToken0(vol: BigDecimal) {
    assert(false, "not implemented")
  }

  set volumeToken1(vol: BigDecimal) {
    assert(false, "not implemented")
  }

  set feesUSD(vol: BigDecimal) {
    assert(false, "not implemented")
  }
}
...
export function handleSwap(event: SwapEvent): void {
  ...
  let poolData = new PoolData(timestamp, pool)  // used updatePoolDayData
